...
public class CalculatorRomainPresenter_MainUiBinderImpl implements UiBinder<com.google.gwt.user.client.ui.HTMLPanel, org.insset.client.calculator.roman.CalculatorRomainPresenter>, org.insset.client.calculator.roman.CalculatorRomainPresenter.MainUiBinder {
  ...
  class Widgets {
    ...
    private com.google.gwt.user.client.ui.FlowPanel build_f_FlowPanel21() {
      ...
      // Setup section.
      f_FlowPanel21.add(get_boutonClearAll());
      f_FlowPanel21.setStyleName("clear-section");

      return f_FlowPanel21;
    }

    /**
     * Getter for boutonClearAll called 1 times. Type: DEFAULT. Build precedence: 4.
     */
    private com.google.gwt.user.client.ui.ResetButton get_boutonClearAll() {
      return build_boutonClearAll();
    }
    private com.google.gwt.user.client.ui.ResetButton build_boutonClearAll() {
      // Creation section.
      final com.google.gwt.user.client.ui.ResetButton boutonClearAll = (com.google.gwt.user.client.ui.ResetButton) GWT.create(com.google.gwt.user.client.ui.ResetButton.class);
      // Setup section.
      boutonClearAll.setText("Tout Effacer");

      this.owner.boutonClearAll = boutonClearAll;

      return boutonClearAll;
    }
